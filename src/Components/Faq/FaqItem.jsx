...
const FaqItem = (props) => {
  ...
  return (
    <>
      ...
      >
        <motion.div animate={{ opacity: visibleAnswer ? 0 : 1,
...
<switch>
      ...
      <motion.div
        ...
        onClick={() => setVisibleAnswer(!visibleAnswer)}
      >
        <svg className="base" xmlns="http://www.w3.org/2000/svg" width="571" height="83" viewBox="0 0 571 83" fill="none">
<path d="M2.83695 13.1405C0.617939 7.55953 4.72958 1.50003 10.7355 1.50003L560.998 1.50006C565.692 1.50006 569.498 5.30564 569.498 10.0001L569.498 41.5L569.498 73C569.498 77.6944 565.692 81.5 560.998 81.5L10.7356 81.4999C4.72961 81.4999 0.617965 75.4404 2.83697 69.8595L12.4234 45.7489C13.5083 43.0202 13.5083 39.9798 12.4234 37.2511L2.83695 13.1405Z" fill="#F9EEE1" stroke="black" stroke-width="3"/>
<switch>
            <foreignObject
              x="3%"
              y="3%"
